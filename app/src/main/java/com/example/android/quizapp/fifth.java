...
public class fifth extends AppCompatActivity {
    ...
    public void btn(View v){
        points = points + 0;
        Intent ansone = new Intent(this, total.class);
    ...
    public void btn1(View v){
        points = points + 1;
        Intent anstwo = new Intent(this, total.class);
    ...
    public void btn2(View v){
        points = points + 0;
        Intent ansthree = new Intent(this, total.class);
    ...
    public void btn3(View v){
        points = points + 0;
        Intent ansfour = new Intent(this, total.class);
    ...
    public void skip(View view) {
        points = points + 0;
        Intent skipping = new Intent(this, total.class);
